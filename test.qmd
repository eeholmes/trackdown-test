...
trackdown::upload_file(file = here::here("test.code.Rmd"),
                       gpath = "_00_IEA-TEST/", hide_code = TRUE)
 
trackdown::update_file(file = here::here("test.code.Rmd"), 
                        gpath = "_00_IEA-TEST/", hide_code = TRUE)
 
trackdown::download_file(file = here::here("test.code.Rmd"),
                          gpath = "_00_IEA-TEST/")
...
include_graphics(here::here("images", "plot.png"))
```
